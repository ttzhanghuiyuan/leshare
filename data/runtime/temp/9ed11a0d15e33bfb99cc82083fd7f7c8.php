<?php /*a:2:{s:81:"/home/abner/leshare/public/themes/admin_simpleboot3/admin/class_schedule/add.html";i:1606527683;s:70:"/home/abner/leshare/public/themes/admin_simpleboot3/public/header.html";i:1598770981;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('class_schedule/add'); ?>"><?php echo lang('课表添加'); ?></a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('class_schedule/addpost'); ?>">
        <!--课表类型-->
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <select class="form-control" name="sch_type" id="input-sch-type" style="width: 150px;">
                    <?php if(is_array($sch_type_list) || $sch_type_list instanceof \think\Collection || $sch_type_list instanceof \think\Paginator): if( count($sch_type_list)==0 ) : echo "" ;else: foreach($sch_type_list as $key=>$vo): ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <select class="form-control" name="level_id" id="input-level-id" style="width: 150px;">
                    <?php if(is_array($class_level_list) || $class_level_list instanceof \think\Collection || $class_level_list instanceof \think\Paginator): if( count($class_level_list)==0 ) : echo "" ;else: foreach($class_level_list as $key=>$vo): ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <select class="form-control" name="week" id="input-week" style="width: 150px;">
                    <?php if(is_array($week) || $week instanceof \think\Collection || $week instanceof \think\Paginator): if( count($week)==0 ) : echo "" ;else: foreach($week as $key=>$vo): ?>
                        <option value="<?php echo $key; ?>"><?php echo $vo; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-3">
                <input type="text" class="form-control" id="input-start-hour" name="start_hour">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-3">
                <input type="text" class="form-control" id="input-start-minute" name="start_minute">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-3">
                <input type="text" class="form-control" id="input-end-hour" name="end_hour">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-3">
                <input type="text" class="form-control" id="input-end-minute" name="end_minute">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-5">
                <select class="form-control" name="enable_flag" id="input-enable-flag" style="width: 150px;">
                    <?php if(is_array($enable_flag_list) || $enable_flag_list instanceof \think\Collection || $enable_flag_list instanceof \think\Paginator): if( count($enable_flag_list)==0 ) : echo "" ;else: foreach($enable_flag_list as $key=>$vo): ?>
                        <option value="<?php echo $key; ?>"><?php echo $vo; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
