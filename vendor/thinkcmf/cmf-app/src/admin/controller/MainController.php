...
class MainController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $defaultDashboardWidgets = [
            ...
            '_SystemContributors'     => ['name' => 'Contributors', 'is_system' => 0],
            '_SystemCustom1'          => ['name' => 'Custom1', 'is_system' => 0],
            '_SystemCustom2'          => ['name' => 'Custom2', 'is_system' => 0],
            '_SystemCustom3'          => ['name' => 'Custom3', 'is_system' => 0],
            '_SystemCustom4'          => ['name' => 'Custom4', 'is_system' => 0],
            '_SystemCustom5'          => ['name' => 'Custom5', 'is_system' => 0],
        ];
